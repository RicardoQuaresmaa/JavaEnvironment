...
%>
  ...
  <div class="row" style="height:85%;">
      ...
      <form role="form" action="BultenDetayAdmin.jsp"  runat="server" method="get" enctype="multipart/form-data" id="formiste" name="NewForm116"   class ="form-horizontal"  style="">
