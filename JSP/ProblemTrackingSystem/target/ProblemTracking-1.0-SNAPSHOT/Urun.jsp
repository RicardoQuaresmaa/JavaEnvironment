...
<body>         
  ...
  Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
   ...
   String SQL11 = "select * from UrunView";
...
%>
  ...
  <form role="form" id="form2" name="NewForm11" action="UrunInsert" runat="server" method="post" enctype="multipart/form-data" >
  <div class="form-group" style="margin-left:10%;width:100%">
    <label for="text">Ürün Adı:</label>
    <input type="text" class="form-control" id="Urunnn_adiii" name="Urunnn_adiii_t"   onkeyup="icazet();icazetovaltin(this);" onkeydown="icazet();icazetovaltin(this);"  style="text-align:center;font-size:20px;height:37px;width:100%" >
    ...
    <div> 
        ...
        <select id="sirketler" class="form-control" name="sirketov" onclick="icazet();" style="font-size:17.8px;width:100%;height:40px">
...
<div class="radio" style="margin-left:20%;margin-top:15%;width:100%">
       ...
       <label style="margin-left:20px"><input type="radio" name="optradio" value="psf" id="Pasif" >Pasif</label>
        ...
        <input type="hidden" id="Sirket_ID_d" name="Sirket_ID_dd" value="">
            ...
            <input type="hidden" id="Urun_ID_d" name="Urun_ID_dd" value="">
...
if(!document.NewForm11.Urunnn_adiii_t.value.match(letters))  
{  

document.NewForm11.Urunnn_adiii_t.value = document.NewForm11.Urunnn_adiii_t.value.substring(0,document.NewForm11.Urunnn_adiii_t.value.length-1);


document.NewForm11.Urunnn_adiii_t.focus();  
}  

*/

var ttt=document.NewForm11.Urunnn_adiii_t.value.length;
...
<% rsr1 = stmt.executeQuery(SQL11);    %>
            ...
            var bizimkiler = [
                ...
                ["<%= rsr1.getInt("ID")%>","<%= rsr1.getString("Adi")%>","<%= rsr1.getString("SirketAdi")%>","<%= rsr1.getString("Durum")%>"],
...
$(document).ready(function() {
 ...
 $('#Urun_ID_d').val(data[0]);


             
  $('#Urunnn_adiii').val(data[1]);
   ...
   //  alert(data[0]);
    ...
    //   alert($('#elktat').val());
     ...
     $('#sirketler').on('click', 'option', function () {
       ...
       var element = $(this);
         var Sirket_ID_combo_select = element.attr("value");       
     ...
     //    alert(ddd);
      var der =$('#Urunnn_adiii').val().length;
      if (der>2) {
     $('#butonnn').attr('disabled',false);
