...
%>
  ...
  <form role="form" id="form2" name="NewForm11" action="ProblemInsert" runat="server" method="post" enctype="multipart/form-data" >
...
$(document).ready(function() {
 ...
 //    $('#urunler option[sirketid="'+bny263+'"]').prop('selected',true);    // ve ürün kısmından ürünümüzü seçtikten sonra, üründen ise şirketimzi seçiyorz.
  ...
  $('#form2').attr('action',"ProblemUpdate");
...
{   
    ...
    $('#form2').attr('action',"ProblemDelete");            
    $('#form2').submit();
...
{
     $('#form2').attr('action',"ProblemInsert");
