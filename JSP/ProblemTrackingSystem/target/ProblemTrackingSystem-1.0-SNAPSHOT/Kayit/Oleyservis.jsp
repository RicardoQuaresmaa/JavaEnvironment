...
<body>     
  ...
  <div class="row" style="height:75%;background-color:">
   ...
   <form role="form" action="../OleyServisInserttt" runat="server" method="post" enctype="multipart/form-data" id="form1" name="NewForm" class ="form-horizontal">                                
...
$(document).ready(function() {
  ...
  pasifeal();
    ...
    $('#example tbody').on('click', 'tr', function () {
        ...
        $('#form1').attr('action',"../OleyServisUpdateee");
...
pasifeal();
$('#form1').attr('action',"../OleyServisInserttt");
