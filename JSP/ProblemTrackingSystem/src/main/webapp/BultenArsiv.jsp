...
%>
  ...
  <div class="row" style="height:75%;">
      ...
      <form role="form" action="BultenDetayArsiv.jsp"  runat="server" method="get" enctype="multipart/form-data" id="formiste" name="NewForm116"   class ="form-horizontal"  style="">
