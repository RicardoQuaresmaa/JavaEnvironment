...
%>
  ...
  <form role="form" id="form44" name="NewForm1199" action="BultenOlusturInsertt" runat="server" method="post" enctype="multipart/form-data" >
    ...
    <option class="placeholder" selected disabled value="" selected="true" >Arıza Tipi Seçiniz</option>  
     ...
     <input id="ArizaTipiListe"  name="ArizaTipiListe" onkeyup="arizaTipleriFiltrele();" onkeydown="" onkeypress=""  style="border:none;float:left;font-size:14px;height:38px;margin-left:-300px;margin-top:1px;width:89%;text-align:center;"/>                                                            
    </div>
  </div>   
